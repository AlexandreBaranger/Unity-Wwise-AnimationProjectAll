...
[CustomEditor(typeof(SynthAnimationCurveGenerator))]
public class SynthAnimationCurveGeneratorEditor : Editor
{
    private SynthAnimationCurveGenerator rtpcSyncAnimation;
    private float time;
    private bool playing;
    private float playbackSpeed = 1f;
    private string fileName = "curveValues";
    private void OnEnable()
    {rtpcSyncAnimation = (SynthAnimationCurveGenerator)target;}
